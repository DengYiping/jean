...
pub struct AppPreferences {
    ...
    pub default_effort_level: String, // Effort level for Opus adaptive thinking: low, medium, high, max
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            projects::get_pull_request_review_data,
            projects::get_pull_request_review_summary,
            projects::get_pull_request_review_diff,
            projects::get_pull_request_review_file_contents,
            projects::create_pull_request_inline_comment,
            projects::reply_to_pull_request_review_comment,
            projects::submit_pull_request_review,
            ...
            chat::get_codex_sub_agent_snapshot,
            ...
            codex_cli::resolve_codex_update_command,
