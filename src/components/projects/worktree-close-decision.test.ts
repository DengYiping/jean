...
describe('decideWorktreeMiddleClose', () => {
  ...
  it('confirms when the preference is undefined', () => {
...
describe('decideSessionMiddleClose', () => {
  ...
  it('deletes without confirming when other sessions remain', () => {
    expect(
      decideSessionMiddleClose({
  ...
  it('treats an empty worktree count as the last session', () => {
    expect(
      decideSessionMiddleClose({
