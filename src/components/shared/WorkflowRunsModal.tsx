      ...
      if (projectPath) {
        ...
        if (project) {
          ...
          try {
            ...
            logger.error('[WF-MODAL] Failed to fetch worktrees:', err)
          }
          ...
          if (!targetWorktreeId) {
            try {
              ...
              logger.error('[WF-MODAL] Failed to create base session:', error)
      ...
      if (emptySession) {
        ...
        createSession.mutate(
          { worktreeId, worktreePath },
          {
            ...
            onError: error => {
              logger.error('[WF-MODAL] Failed to create session:', error)
