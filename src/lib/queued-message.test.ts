...
import { buildQueuedMessageWithRefs } from './queued-message'
...
describe('buildQueuedMessageWithRefs', () => {
  it('adds a default prompt for image-only messages', () => {
    const message = buildQueuedMessageWithRefs(
      queuedMessage({
        pendingImages: [
          {
            id: 'img-1',
